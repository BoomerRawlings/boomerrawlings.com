...
## Geographic school navigation — 25 September 2026

Actual browser checks pass on desktop1280, mobile390 and narrow320: recognizable national map with Alaska/Hawaii insets, compact full-text region buttons with no intersecting hit rectangles, region focus around included home-campus points, and zero document-wide horizontal overflow. All four regions preserve exactly15/7/12/8school identifiers without selecting a school. Direct Texas-shape click selects South. Native Enter/Space activates regions and school clusters. Nearby-school chooser survives viewport resizing; selecting a school opens its existing explanation. San Diego State returns7combined housing offenses for2024; Harvard retains its unavailable result. Global search after a selected school clears stale region/selection: Harvard-to-SDSU yields one western match and correct7count after explicit selection. National reset, empty search, school deep links, source jumps and exact return links pass. Every school remains accessible through map clusters and the searchable list; pure tests independently check marker containment/separation, same-location points and no lost identifiers. Browser console shows no errors; temporary viewport overrides reset. No calculations, equations, PDFs or housing-population coverage changed.

Final narrow-screen correction separates Northeast/Midwest label anchors; final empty-search wording directs the reader to another name or region. Point positions remain source-derived; label and cluster centers are navigation presentation only. The independent map source audit verifies all51state outlines and42official directory points, including the corrected full national bounds.
