...
reviewed=[page_path,methods_path,context_path,SITE/'src/components/CampusReader.astro',SITE/'src/components/CampusReaderSources.astro',SITE/'src/lib/campus-reader.js',SITE/'src/data/campus-reader-copy.js',HERE/'READER_COPY_AUDIT.json',HERE/'build_current_reports.py',campus_pdf,heat_pdf,DATA/'dataset.json',DATA/'case_study.json',DATA/'coverage.json',DATA/'source_inventory.json',DATA/'source_cells.csv',DATA/'rates.csv',HERE/'CURRENT_DATA_AUDIT.json',HERE/'README.md',CAMPUS/'research/RESEARCH_REVIEW.md',HEAT/'freshness_2026_09_25/FRESHNESS_AUDIT.md',HEAT/'freshness_2026_09_25/offline_verification.json',HEAT/'revision_models/results/revision_models.csv',HEAT/'revision_models/results/revision_tests.csv']
