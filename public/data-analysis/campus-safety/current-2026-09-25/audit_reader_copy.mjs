...
const reviewed=['src/components/CampusReader.astro','src/components/CampusReaderSources.astro','src/lib/campus-reader.js','src/data/campus-reader-copy.js','src/data/campus-school-context.json','src/pages/writing/data-analysis/campus-safety.astro','src/lib/campus-citations.js'];
