...
curatorNotes:
  - "Start with the note at the top: this is a student proposal produced in May 2026, not a conducted study."
  - "It asks whether attention-bias modification might reduce hostile attention bias and aggression in justice-impacted young adults."
  - "The limitations note identifies what would require further specification before implementation."
nextExhibit:
  href: /about/
...
> Student research proposal produced at Southwestern College in May 2026. The study was not conducted. This web edition removes course administration and adds an editorial limitations note; it is not a preregistered or implementation-ready protocol.

## Introduction

Aggression and poor self-regulation can complicate reentry, especially for young people moving through detention, incarceration, or community settings. Researchers have measured attention bias, decision-making, and biological regulation in several small, specialized offender samples. Those findings suggest that some related processes can be studied and may be modifiable, but they do not establish that the same results would generalize to a community reentry population. This proposal asks whether a practical, low-cost intervention would merit testing in that different setting.
...
The second article was by Tully et al. (2024), and it looked at violent offenders from more of a biological perspective. The researchers studied 30 violent male offenders with antisocial personality disorder, with and without psychopathy, and compared them with 21 healthy non-offenders. The main variable was the striatal glutamate:GABA ratio, which was measured using proton magnetic resonance spectroscopy. Tully et al. (2024) found that offenders with antisocial personality disorder had a significantly reduced striatal glutamate:GABA ratio compared with non-offenders. This article is not an intervention study like Zhao et al. (2022), but it is still important because it supports the idea that violent behavior and poor behavioral control are connected to measurable regulation problems, not just personality labels or moral judgment.

The third article was by Kuhn et al. (2024), which studied risk-taking and decision-making in violent offenders. Their study included 22 male violent offenders and 24 male non-violent controls. Participants completed active and sham transcranial direct current stimulation, or tDCS, over the right dorsolateral prefrontal cortex and then completed the Balloon Analogue Risk Task during fMRI scanning. Kuhn et al. (2024) found that violent offenders showed less optimal decision-making than non-violent controls, and active tDCS improved decision-making and increased prefrontal activity in the offender group. This article is more advanced than what I would actually propose for a community college research project, but it is still relevant because it shows that decision-making problems in offender populations can be measured and can shift after an intervention.

Together, these articles suggest that aggression and behavioral control can be measured in the populations studied and that further intervention research may be worthwhile. Zhao et al. (2022) provides the closest model for this proposal because it directly uses ABM with institutionalized young offenders. Tully et al. (2024) and Kuhn et al. (2024) offer background on other self-regulation processes in small all-male samples; they do not show that ABM would work for community reentry participants. I am not proposing brain imaging or tDCS, because that would not be realistic for the type of study I am designing.
...
Because this study would involve formerly incarcerated young adults, it could proceed only after institutional review board approval. The consent process would need to be especially clear. Participation would not be connected in any way to probation, parole, court status, housing, treatment access, or school standing. Recruitment would not happen through correctional officers or anyone with direct authority over participants, because that would create pressure and would weaken voluntary consent. Compensation would need review for undue influence. Participants would be told that they could stop the study at any time without any penalty.

Confidentiality would be protected by assigning each participant an ID number and storing the identity key separately from study data with restricted access, retention limits, and a deletion schedule approved before recruitment. Results would only be reported at the group level. The study would not use deception. At the end of participation, each person would receive a short debriefing form and a list of counseling and reentry support resources in case the study topics brought up discomfort.
...
If the results supported the hypothesis, it would suggest that attention processes may be worth studying further in reentry settings. Basic computerized training could be more accessible than laboratory interventions. One limitation would be that aggression would still be measured partly through self-report, and the intervention period would be short. A community reentry sample would not be equivalent to the institutionalized youth sample studied by Zhao et al. (2022), so any results would need cautious interpretation.

## Editorial limitations note

This classroom proposal does not include a statistical power analysis, a fully specified validated aggression instrument, a primary analysis and missing-data plan, or operational screening procedures. Those elements—and formal ethics review—would be required before the study could be implemented. The sample size of 48 is therefore illustrative, not justified as sufficient to detect an effect.
