...
The default uses **current institutional annual reports checked on 25 September 2026**, retaining each cell's report edition, calendar report year, branch, geography, raw value and source locator. Latest reports can revise older years or have inconsistent labels. Missing, ambiguous or unverified cells are withheld from affected calculations. The complete current source inventory records both successful retrievals and gaps. [Current source inventory](/data-analysis/campus-safety/current-2026-09-25/source_inventory.json), [source-cell decisions](/data-analysis/campus-safety/current-2026-09-25/source_cells.csv).
...
The opening cohort includes all 11 institutions with a documented resident denominator, even when a selected count is unavailable. Current counts and older federal coverage differ; availability is reported with each selection. No qualified 2025 resident denominator was established. Capacity, rounded housing estimates, undergraduate-only occupancy and prior-year residents are not substituted. [Current coverage](/data-analysis/campus-safety/current-2026-09-25/coverage.json), [population-source search](/data-analysis/campus-safety/current-2026-09-25/source_inventory.json).
