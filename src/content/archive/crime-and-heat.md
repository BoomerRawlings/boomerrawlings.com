...
**Independent reporting qualification.** DOJ's June 2026 documentation identifies incomplete San Diego County Sheriff reporting in November–December 2024 and January–June 2025 for its arrest and DV-call datasets. The current models retain the two flagged 2024 months. This strengthens the concern about reporting completeness but does not identify which supplied records are missing or establish why. No numerical correction or imputation follows from this notice. The separately published source supplement documents this new evidence; the displayed estimates remain the versioned results described here. [DOJ arrest context, p. 7](https://data-openjustice.doj.ca.gov/sites/default/files/dataset/2026-07/Arrests%20Context_0615026.pdf#page=7), [independent source supplement](#external-validation).
