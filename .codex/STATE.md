...
- Mode: continuation. Objective: move Data Analysis under Writing; verify Vista counts and significance at alpha=0.05. Prior general study, DV PDF and requested emails complete.
- Published commit9dc0d5f; GitHub Pages run36063019518 succeeded. Live /data-analysis/crime-and-heat/ and index/navigation verified; all67public artifacts match SHA256 manifests.
- Source:214745raw rows/136313source-ID proxies;12478core DV. Partial2018,incomplete2025,no2026. Public aggregates only; no individual identifiers or street records.
- General primary:58770eligible groups,106fitted ZIPs;+1.87% per10F,95%CI−0.05%to+3.83%,inconclusive. Separate DV primary:6637groups/95ZIPs,+2.9%,CI−1.0%to+7.0%. Retrospective families distinct; no causal/countywide-incidence claim.
- Verification: four DV audit passes; independent general coefficient/SE replication;55-member public package extracted and six models reproduced exactly;2148944category cells reconcile. Categories overlap. Source hashes unchanged.
- UI: all-record/category/year/locality/weekday/hour summaries; ZIP daily high/mean/low, zero-inclusive denominators and CSV exports. Static models do not refit with filters. Real downloaded CSV and invalid ranges verified. Desktop1280/mobile390/320 inspected, no research-page overflow; live totals58770/6637verified.
- Mathematical typography: locally bundled KaTeX, static HTML/accessible MathML, all14expressions visually checked. PDF12pages,267003bytes, vector equations and embedded math fonts; every page visually reviewed, results/citations unchanged. PDF SHA256:babe621e7f08aea6d949f3d2f760998e6a4f382af3db2ede0f20da1d16cc3832.
- Final npm test, artifact-byte preservation, link and source reviews pass. Revised PDF sent to user; journalist original-thread reply sent with same267003byteattachment and webpage-focused body. Sent headers/thread/attachment metadata verified.
- Current update: nested /writing/data-analysis/ routes, Writing subsection, legacy page redirects, unchanged public assets/PDF. Primary p-values now explicit near findings; city note clarifies coverage and denominators. npm test, desktop/mobile browser navigation, legacy redirect, city all/DV counts,14MathML expressions and PDF hash pass; publication pending.
- Rechecked primary p-values from coefficients/SE: general0.0560761 and DV0.1525832; neither meets0.05. Vista original-source audit confirms19315groups/1727core, not a charge-row or city-alias inflation. Detention/court classification only18groups. Shared court/jail/station block matches996groups, not confirmed bookings; broader warrant/detention exclusion leaves16001Vista groups versus8642SanMarcos. Unequal agency coverage and no population denominator prevent municipal-risk comparison.
- Next: publish verified hierarchy and verify live routes/assets. Retain unconfirmed agency completeness/date semantics and modeled-weather limitations. Preserve unrelated objectives below.
